                ...
                <div class="right">
                    <div class="right-parent">
                        ...
                        <div class="right-children">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="process_update_product.php?product_id=<?php echo $product_id ?>" id="my-form">
                                ...
                                <div class="add-product-detail">
                                    ...
                                    <br>
                                    <input type="text" name="product_name" id="product_name" value="<?php echo $product['product_name'] ?>">
                                    <br>
                                    <br>
                                    <label>Giá sản phẩm: </label>
                                    <br>
                                    <input type="number" name="product_price" id="product_price" value="<?php echo $product['product_price'] ?>"> 
                                    <br>
                                    <br>
                                    ...
                                    <br>
                                    <input type="text" name="product_trademark" class="product_trademark" id="product_trademark" value="<?php echo $product['product_trademark'] ?>">
                                    <br>
                                    <br>
                                    <label>Mô tả: </label>
                                    <br>
                                    <input type="text" class="product_describe" name="product_describe" class="product_describe" id="product_describe" value="<?php echo $product['product_describe'] ?>">
                                    <br>
                                </div>
                                <div class="add-product-size">
                                    <label>Số lượng size 38:</label>
                                    <input type="number" name="product_quantity_38" id="product_quantity_38" class="product_quantity" value="<?php echo $product['size_38'] ?>">
                                    <br>
                                    <br>
                                    <label>Số lượng size 39:</label>
                                    <input type="number" name="product_quantity_39" id="product_quantity_39" class="product_quantity" value="<?php echo $product['size_39'] ?>">
                                    <br>
                                    <br>
                                    <label>Số lượng size 40:</label>
                                    <input type="number" name="product_quantity_40" id="product_quantity_40" class="product_quantity" value="<?php echo $product['size_40'] ?>">

                                    <br>
                                    <br>
                                    <label>Số lượng size 41:</label>
                                    <input type="number" name="product_quantity_41" id="product_quantity_41" class="product_quantity" value="<?php echo $product['size_41'] ?>">
                                    <br>
                                    <br>
                                    <label>Số lượng size 42:</label>
                                    <input type="number" name="product_quantity_42" id="product_quantity_42" class="product_quantity" value="<?php echo $product['size_42'] ?>">
                                </div>
                                <div class="btn-add-product">
                                    <button type="submit" name="submit" value="Upload">Sửa sản phẩm</button>
                                </div>
                            </form>
                            <?php endforeach ?>
                        </div>
