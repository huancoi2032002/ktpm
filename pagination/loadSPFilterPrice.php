    ...
    if($mySelect === "low_to_high_price"){
        ...
        <?php }?>
            <div class="number_pages">
                ...
                for ($i = 1; $i <= $sotrang; $i++) {?>
                    <a href="javascript:loadSPFilterPrice('<?php echo $mySelect ?>', <?php echo $i ?>)" class="number_page"><div><p><?php echo $i ?></p></div></a>
                <?php
                };
                ?>
            </div>
